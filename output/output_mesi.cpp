/******************************
  Program "output_mesi.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "output_mesi"
#define BITS_IN_WORLD 7656
#define ALIGN
...
class mu_1_PermissionType: public mu__byte
{
 public:
  ...
  mu_1_PermissionType (const char *name, int os): mu__byte(1, 4, 3, name, os) {};
  mu_1_PermissionType (void): mu__byte(1, 4, 3) {};
  mu_1_PermissionType (int val): mu__byte(1, 4, 3, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
class mu_1_MessageType: public mu__byte
{
 public:
  ...
  mu_1_MessageType (const char *name, int os): mu__byte(5, 18, 4, name, os) {};
  mu_1_MessageType (void): mu__byte(5, 18, 4) {};
  mu_1_MessageType (int val): mu__byte(5, 18, 4, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
const char *mu_1_MessageType::values[] = {"GetSL1C1","GetML1C1","PutSL1C1","Inv_AckL1C1","GetM_Ack_DL1C1","GetS_AckL1C1","WBL1C1","PutML1C1","PutEL1C1","GetM_Ack_ADL1C1","InvL1C1","Put_AckL1C1","Fwd_GetSL1C1","Fwd_GetML1C1",NULL };
...
class mu_1_s_directoryL1C1: public mu__byte
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1_s_directoryL1C1::values[ int(val) - 19] );
    else return ( s << "Undefined" );
  };

  mu_1_s_directoryL1C1 (const char *name, int os): mu__byte(19, 24, 3, name, os) {};
  mu_1_s_directoryL1C1 (void): mu__byte(19, 24, 3) {};
  mu_1_s_directoryL1C1 (int val): mu__byte(19, 24, 3, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
const char *mu_1_s_directoryL1C1::values[] = {"directoryL1C1_S","directoryL1C1_M_GetS","directoryL1C1_M","directoryL1C1_I","directoryL1C1_E_GetS","directoryL1C1_E",NULL };
...
class mu_1_s_cacheL1C1: public mu__byte
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1_s_cacheL1C1::values[ int(val) - 25] );
    else return ( s << "Undefined" );
  };

  mu_1_s_cacheL1C1 (const char *name, int os): mu__byte(25, 39, 4, name, os) {};
  mu_1_s_cacheL1C1 (void): mu__byte(25, 39, 4) {};
  mu_1_s_cacheL1C1 (int val): mu__byte(25, 39, 4, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
const char *mu_1_s_cacheL1C1::values[] = {"cacheL1C1_S_store_GetM_Ack_AD","cacheL1C1_S_store","cacheL1C1_S_evict_x_I","cacheL1C1_S_evict","cacheL1C1_S","cacheL1C1_M_evict_x_I","cacheL1C1_M_evict","cacheL1C1_M","cacheL1C1_I_store_GetM_Ack_AD","cacheL1C1_I_store","cacheL1C1_I_load","cacheL1C1_I","cacheL1C1_E_evict_x_I","cacheL1C1_E_evict","cacheL1C1_E",NULL };
...
class mu_1_OBJSET_directoryL1C1: public mu__byte
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1_OBJSET_directoryL1C1::values[ int(val) - 40] );
    else return ( s << "Undefined" );
  };

  mu_1_OBJSET_directoryL1C1 (const char *name, int os): mu__byte(40, 40, 1, name, os) {};
  mu_1_OBJSET_directoryL1C1 (void): mu__byte(40, 40, 1) {};
  mu_1_OBJSET_directoryL1C1 (int val): mu__byte(40, 40, 1, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
class mu_1_OBJSET_cacheL1C1: public mu__byte
{
 public:
  ...
  friend ostream& operator<< (ostream& s, mu_1_OBJSET_cacheL1C1& val)
    {
      if (val.defined())
	return ( s << mu_1_OBJSET_cacheL1C1::values[ int(val) - 41 ] );
      else
	return ( s << "Undefined" );
    };

  mu_1_OBJSET_cacheL1C1 (const char *name, int os): mu__byte(41, 43, 2, name, os) {};
  mu_1_OBJSET_cacheL1C1 (void): mu__byte(41, 43, 2) {};
  mu_1_OBJSET_cacheL1C1 (int val): mu__byte(41, 43, 2, "Parameter or function result.", 0)
    { operator=(val); };
  const char * Name() { return values[ value() -41]; };
  virtual void print()
    {
      if (defined()) cout << name << ':' << values[ value() - 41] << '\n';
...
class mu_1_C1Machines: public mu__byte
{
 public:
  ...
  int indexvalue()
  {
    if ((value() >= 40) && (value() <= 40)) return (value() - 40);
    if ((value() >= 41) && (value() <= 43)) return (value() - 40);
  return 0;
  };
  inline int unionassign(int val)
  {
    if (val >= 0 && val <= 0) return value(val+40);
    if (val >= 1 && val <= 3) return value(val+40);
  return 0;
  };
...
const char *mu_1_C1Machines::values[] = {"directoryL1C1","OBJSET_cacheL1C1_1","OBJSET_cacheL1C1_2","OBJSET_cacheL1C1_3",NULL };
...
const char *mu_1_Machines::values[] = {"directoryL1C1","OBJSET_cacheL1C1_1","OBJSET_cacheL1C1_2","OBJSET_cacheL1C1_3",NULL };
 ...
 public:
  ...
  mu_1_thread& operator[] (int index) /* const */
  {
	...
	if (index==UNDEFVAL) 
	  ...
	  Error.Error("Funny index value %d for %s: OBJSET_cacheL1C1 is internally represented from 41 to 43.\nInternal Error in Type checking.",index, name);
	return array[0];
      }
#else
    return array[ index - 41 ];
...
class mu__subrange_26: public mu__byte
{
 public:
  ...
  mu__subrange_26 (const char *name, int os): mu__byte(0, 9, 4, name, os) {};
  mu__subrange_26 (void): mu__byte(0, 9, 4) {};
  mu__subrange_26 (int val): mu__byte(0, 9, 4, "Parameter or function result.", 0)
  {
    operator=(val);
  };
  char * Name() { return tsprintf("%d",value()); };
...
if (n) array[i].set_self_ar(n,"directoryL1C1", i * 480 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"OBJSET_cacheL1C1_1", i * 480 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"OBJSET_cacheL1C1_2", i * 480 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"OBJSET_cacheL1C1_3", i * 480 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
}
...
class mu_1__type_6: public mu__byte
{
 public:
  ...
  mu_1__type_6 (const char *name, int os): mu__byte(0, 10, 4, name, os) {};
  mu_1__type_6 (void): mu__byte(0, 10, 4) {};
  mu_1__type_6 (int val): mu__byte(0, 10, 4, "Parameter or function result.", 0)
  {
    operator=(val);
  };
  char * Name() { return tsprintf("%d",value()); };
...
if (n) array[i].set_self_ar(n,"directoryL1C1", i * 560 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"OBJSET_cacheL1C1_1", i * 560 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"OBJSET_cacheL1C1_2", i * 560 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"OBJSET_cacheL1C1_3", i * 560 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
}
...
/*** begin multiset declaration ***/
class mu_1_v_cacheL1C1_id: public mu__byte
{
 public:
  inline int operator=(int val) { return value(val); };
  inline int operator=(const mu_1_v_cacheL1C1_id& val) { return value(val.value()); };
  inline operator int() const { return value(); };
  mu_1_v_cacheL1C1_id () : mu__byte(0,2,0) {};
  mu_1_v_cacheL1C1_id (int val) : mu__byte(0,2,0, "Parameter or function result.",0) {operator=(val); };
  char * Name() { return tsprintf("%d", value()); };
};
class mu_1_v_cacheL1C1
{
 public:
 ...
 public:
  ...
  void set_self_2( const char *n, const char *n2, int os);
  void set_self_ar( const char *n, const char *n2, int os);
  mu_1_v_cacheL1C1 (const char *n, int os): current_size(0), max_size(0) { set_self(n, os); };
  mu_1_v_cacheL1C1 ( void ): current_size(0), max_size(0) {};
  virtual ~mu_1_v_cacheL1C1 ();
  ...
  mu_1_v_cacheL1C1& operator= (const mu_1_v_cacheL1C1& from)
  {
    for (int i = 0; i < 3; i++)
    {
        array[i].value(from.array[i].value());
...
friend int CompareWeight(mu_1_v_cacheL1C1& a, mu_1_v_cacheL1C1& b)
  {
    return 0;
  }
friend int Compare(mu_1_v_cacheL1C1& a, mu_1_v_cacheL1C1& b)
  {
    int w;
    for (int i=0; i<3; i++) {
      w = Compare(a.array[i], b.array[i]);
   ...
   void update_size()
  {
   ...
   inline bool in(const mu_1_v_cacheL1C1_id& id)
  { return valid[(int)id].value(); }
  void print()
  {
    for (int i = 0; i < 3; i++)
  ...
  void multisetremove(const mu_1_v_cacheL1C1_id &id)
  {
    update_size();
    if (!valid[(int)id].value()) Error.Error("Internal Error: Illegal Multiset element selected.");
    valid[(int)id].value(FALSE);
  ...
  void mu_1_v_cacheL1C1::set_self_ar( const char *n1, const char *n2, int os ) {
    if (n1 == NULL) {set_self(NULL, 0); return;}
    int l1 = strlen(n1), l2 = strlen(n2);
    strcpy( longname, n1 );
    longname[l1] = '[';
  ...
  void mu_1_v_cacheL1C1::set_self_2( const char *n1, const char *n2, int os ) {
    if (n1 == NULL) {set_self(NULL, 0); return;}
    strcpy( longname, n1 );
    strcat( longname, n2 );
    set_self( longname, os );
  };
void mu_1_v_cacheL1C1::set_self( const char *n, int os)
{
  int i,k;
  name = (char *)n;
  for(i = 0; i < 3; i++)
...
mu_1_v_cacheL1C1::~mu_1_v_cacheL1C1()
{
}
/*** end multiset declaration ***/
mu_1_v_cacheL1C1 mu_1_v_cacheL1C1_undefined_var;

class mu_1_cnt_v_cacheL1C1: public mu__byte
{
 public:
  inline int operator=(int val) { return mu__byte::operator=(val); };
  inline int operator=(const mu_1_cnt_v_cacheL1C1& val) { return mu__byte::operator=((int) val); };
  mu_1_cnt_v_cacheL1C1 (const char *name, int os): mu__byte(0, 3, 3, name, os) {};
  mu_1_cnt_v_cacheL1C1 (void): mu__byte(0, 3, 3) {};
  mu_1_cnt_v_cacheL1C1 (int val): mu__byte(0, 3, 3, "Parameter or function result.", 0)
  {
    operator=(val);
  };
  char * Name() { return tsprintf("%d",value()); };
...
/*** end of subrange decl ***/
mu_1_cnt_v_cacheL1C1 mu_1_cnt_v_cacheL1C1_undefined_var;
...
const int mu_O_NET_MAX = 10;
const int mu_U_NET_MAX = 10;
const int mu_NrCachesL1C1 = 3;
const int mu_load = 1;
const int mu_store = 2;
const int mu_evict = 3;
const int mu_none = 4;
const int mu_GetSL1C1 = 5;
const int mu_GetML1C1 = 6;
const int mu_PutSL1C1 = 7;
const int mu_Inv_AckL1C1 = 8;
const int mu_GetM_Ack_DL1C1 = 9;
const int mu_GetS_AckL1C1 = 10;
const int mu_WBL1C1 = 11;
const int mu_PutML1C1 = 12;
const int mu_PutEL1C1 = 13;
const int mu_GetM_Ack_ADL1C1 = 14;
const int mu_InvL1C1 = 15;
const int mu_Put_AckL1C1 = 16;
const int mu_Fwd_GetSL1C1 = 17;
const int mu_Fwd_GetML1C1 = 18;
const int mu_directoryL1C1_S = 19;
const int mu_directoryL1C1_M_GetS = 20;
const int mu_directoryL1C1_M = 21;
const int mu_directoryL1C1_I = 22;
const int mu_directoryL1C1_E_GetS = 23;
const int mu_directoryL1C1_E = 24;
const int mu_cacheL1C1_S_store_GetM_Ack_AD = 25;
const int mu_cacheL1C1_S_store = 26;
const int mu_cacheL1C1_S_evict_x_I = 27;
const int mu_cacheL1C1_S_evict = 28;
const int mu_cacheL1C1_S = 29;
const int mu_cacheL1C1_M_evict_x_I = 30;
const int mu_cacheL1C1_M_evict = 31;
const int mu_cacheL1C1_M = 32;
const int mu_cacheL1C1_I_store_GetM_Ack_AD = 33;
const int mu_cacheL1C1_I_store = 34;
const int mu_cacheL1C1_I_load = 35;
const int mu_cacheL1C1_I = 36;
const int mu_cacheL1C1_E_evict_x_I = 37;
const int mu_cacheL1C1_E_evict = 38;
const int mu_cacheL1C1_E = 39;
const int mu_directoryL1C1 = 40;
const int mu_OBJSET_cacheL1C1_1 = 41;
const int mu_OBJSET_cacheL1C1_2 = 42;
const int mu_OBJSET_cacheL1C1_3 = 43;
/*** Variable declaration ***/
mu_1_NET_Ordered mu_fwd("fwd",0);

/*** Variable declaration ***/
mu_1_NET_Ordered_cnt mu_cnt_fwd("cnt_fwd",1920);

/*** Variable declaration ***/
mu_1_NET_Ordered mu_resp("resp",1952);

/*** Variable declaration ***/
mu_1_NET_Ordered_cnt mu_cnt_resp("cnt_resp",3872);

/*** Variable declaration ***/
mu_1_NET_Ordered mu_req("req",3904);

/*** Variable declaration ***/
mu_1_NET_Ordered_cnt mu_cnt_req("cnt_req",5824);

/*** Variable declaration ***/
mu_1_PermMonitor mu_g_perm("g_perm",5856);

/*** Variable declaration ***/
mu_1_OBJ_directoryL1C1 mu_i_directoryL1C1("i_directoryL1C1",6432);

/*** Variable declaration ***/
mu_1_OBJ_cacheL1C1 mu_i_cacheL1C1("i_cacheL1C1",6648);

/*** Variable declaration ***/
mu_1_thread mu_i_thread1("i_thread1",6936);

/*** Variable declaration ***/
mu_1_thread mu_i_thread2("i_thread2",7032);

/*** Variable declaration ***/
mu_1_thread mu_i_thread3("i_thread3",7128);

/*** Variable declaration ***/
mu_1_threadlist mu_i_threadlist("i_threadlist",7224);

/*** Variable declaration ***/
mu_1_threadIndexes mu_i_threadIndexes("i_threadIndexes",7512);

/*** Variable declaration ***/
mu_1__type_12 mu_initializer("initializer",7632);

/*** Variable declaration ***/
mu_1__type_13 mu_loadedZeroCounter("loadedZeroCounter",7640);

/*** Variable declaration ***/
mu_1__type_14 mu_instructionsExecuted("instructionsExecuted",7648);

void mu_ResetMachine_directoryL1C1()
{
{
...
mu_i_directoryL1C1[mu_i].mu_cb[mu_a].mu_cacheL1C1.undefine();
mu_i_directoryL1C1[mu_i].mu_cb[mu_a].mu_ownerL1C1.undefine();
};
};
};
};
...
void mu_ResetMachine_cacheL1C1()
{
{
for(int mu_i = 41; mu_i <= 43; mu_i++) {
{
for(int mu_a = 0; mu_a <= 2; mu_a++) {
...
{
mu_ResetMachine_directoryL1C1 (  );
mu_ResetMachine_cacheL1C1 (  );
};
/*** end procedure declaration ***/
...
/*** begin multisetcount 0 declaration ***/
  ...
  for (mu_i = 0; ; mu_i=mu_i+1)
	...
	{
	  if ( (mu_l_perm_set[mu_i]) == (mu_acc_type) ) mu__intexpr16++;
	}
      if (mu_i == 3-1) break;
    }
  }
...
{
{
for(int mu_m = 40; mu_m <= 43; mu_m++)
  if (( ( mu_m >= 41 ) && ( mu_m <= 43 ) )|| ( ( mu_m >= 40 ) && ( mu_m <= 40 ) )) {
{
...
void mu_AddElement_cacheL1C1(mu_1_v_cacheL1C1& mu_sv, const mu_1_Machines& mu_n)
{
/*** begin multisetcount 1 declaration ***/
  int mu__intexpr17 = 0;
  {
  mu_1_v_cacheL1C1_id mu_i;
  for (mu_i = 0; ; mu_i=mu_i+1)
    {
...
void mu_RemoveElement_cacheL1C1(mu_1_v_cacheL1C1& mu_sv, const mu_1_Machines& mu_n)
{
  ...
  for (mu_i = 0; ; mu_i=mu_i+1)
    {
      if (mu_sv.valid[(int)mu_i].value())
	{
	  if ( (mu_sv[mu_i]) == (mu_n) ) mu__intexpr18++;
	}
      if (mu_i == 3-1) break;
    }
  }
...
/*** end multisetremove 0 declaration ***/
  mu_1_v_cacheL1C1_id mu__idexpr19;
  mu_1_v_cacheL1C1_id mu_i;
  for (mu_i = 0; ; mu_i=mu_i+1)
    {
      if (mu_sv.valid[(int)mu_i].value())
	{
	  if ( (mu_sv[mu_i]) == (mu_n) ) { mu__idexpr19 = mu_i; mu_sv.multisetremove(mu__idexpr19); };
	}
      if (mu_i == 3-1) break;
    }
/*** end multisetremove 0 declaration ***/
...
void mu_ClearVector_cacheL1C1(mu_1_v_cacheL1C1& mu_sv)
{
/*** end multisetremove 1 declaration ***/
  mu_1_v_cacheL1C1_id mu__idexpr20;
  mu_1_v_cacheL1C1_id mu_i;
  for (mu_i = 0; ; mu_i=mu_i+1)
    {
      if (mu_sv.valid[(int)mu_i].value())
	{
	  if ( mu_true ) { mu__idexpr20 = mu_i; mu_sv.multisetremove(mu__idexpr20); };
	}
      if (mu_i == 3-1) break;
    }
/*** end multisetremove 1 declaration ***/
...
mu_0_boolean mu_IsElement_cacheL1C1(mu_1_v_cacheL1C1& mu_sv,const mu_1_Machines& mu_n)
{
  ...
  for (mu_i = 0; ; mu_i=mu_i+1)
    {
      if (mu_sv.valid[(int)mu_i].value())
	{
	  if ( (mu_sv[mu_i]) == (mu_n) ) mu__intexpr22++;
	}
      if (mu_i == 3-1) break;
    }
  }
...
return mu_false;
	Error.Error("The end of function IsElement_cacheL1C1 reached without returning values.");
};
/*** end function declaration ***/

mu_0_boolean mu_HasElement_cacheL1C1(mu_1_v_cacheL1C1& mu_sv,const mu_1_Machines& mu_n)
{
...
return mu_true;
	Error.Error("The end of function HasElement_cacheL1C1 reached without returning values.");
};
/*** end function declaration ***/

mu_1_cnt_v_cacheL1C1 mu_VectorCount_cacheL1C1(mu_1_v_cacheL1C1& mu_sv)
{
...
return mu__intexpr24;
	Error.Error("The end of function VectorCount_cacheL1C1 reached without returning values.");
};
/*** end function declaration ***/
...
{
int mu__ub25 = (mu_cnt_fwd[mu_dst]) - (1);
...
{
int mu__ub26 = (mu_cnt_resp[mu_dst]) - (1);
...
{
int mu__ub27 = (mu_cnt_req[mu_dst]) - (1);
...
void mu_Multicast_fwd_v_cacheL1C1(mu_1_Message& mu_msg, mu_1_v_cacheL1C1& mu_dst_vect, const mu_1_Machines& mu_src)
{
{
for(int mu_n = 40; mu_n <= 43; mu_n++)
  if (( ( mu_n >= 41 ) && ( mu_n <= 43 ) )|| ( ( mu_n >= 40 ) && ( mu_n <= 40 ) )) {
...
/*** begin multisetcount 7 declaration ***/
  ...
  for (mu_i = 0; ; mu_i=mu_i+1)
	...
	{
	  if ( (mu_dst_vect[mu_i]) == (mu_n) ) mu__intexpr28++;
	}
      if (mu_i == 3-1) break;
    }
  }
...
{
{
for(int mu_dst = 40; mu_dst <= 43; mu_dst++)
  if (( ( mu_dst >= 41 ) && ( mu_dst <= 43 ) )|| ( ( mu_dst >= 40 ) && ( mu_dst <= 40 ) )) {
{
for(int mu_src = 40; mu_src <= 43; mu_src++)
  if (( ( mu_src >= 41 ) && ( mu_src <= 43 ) )|| ( ( mu_src >= 40 ) && ( mu_src <= 40 ) )) {
if ( (mu_cnt_req[mu_dst]) >= (6) )
{
return mu_false;
}
};
...
if (mu_acksExpectedL1C1.isundefined())
  mu_Message.mu_acksExpectedL1C1.undefine();
else
  mu_Message.mu_acksExpectedL1C1 = mu_acksExpectedL1C1;
return mu_Message;
	Error.Error("The end of function RespAckL1C1 reached without returning values.");
};
/*** end function declaration ***/

void mu_FSM_Access_cacheL1C1_E_evict(const mu_1_Address& mu_adr, const mu_1_OBJSET_cacheL1C1& mu_m)
{
/*** Variable declaration ***/
...
mu_msg = mu_AckL1C1( mu_adr, mu_PutEL1C1, (int)mu_m, (int)mu_directoryL1C1 );
mu_Send_req ( mu_msg, (int)mu_m );
mu_cbe.mu_State = mu_cacheL1C1_E_evict;
}
};
/*** end procedure declaration ***/

void mu_FSM_Access_cacheL1C1_E_load(const mu_1_Address& mu_adr, const mu_1_OBJSET_cacheL1C1& mu_m)
{
{
  mu_1_ENTRY_cacheL1C1& mu_cbe = mu_i_cacheL1C1[mu_m].mu_cb[mu_adr];
mu_Set_perm ( mu_load, mu_adr, (int)mu_m );
mu_cbe.mu_State = mu_cacheL1C1_E;
...
void mu_FSM_Access_cacheL1C1_E_store(const mu_1_Address& mu_adr, const mu_1_OBJSET_cacheL1C1& mu_m)
{
{
  mu_1_ENTRY_cacheL1C1& mu_cbe = mu_i_cacheL1C1[mu_m].mu_cb[mu_adr];
...
void mu_FSM_Access_cacheL1C1_I_store(const mu_1_Address& mu_adr, const mu_1_OBJSET_cacheL1C1& mu_m)
{
/*** Variable declaration ***/
mu_1_Message mu_msg("msg",0);
...
void mu_FSM_Access_cacheL1C1_S_store(const mu_1_Address& mu_adr, const mu_1_OBJSET_cacheL1C1& mu_m)
{
/*** Variable declaration ***/
mu_1_Message mu_msg("msg",0);
...
mu_Send_fwd ( mu_msg, (int)mu_m );
mu_AddElement_cacheL1C1 ( mu_cbe.mu_cacheL1C1, mu_inmsg.mu_src );
mu_AddElement_cacheL1C1 ( mu_cbe.mu_cacheL1C1, mu_cbe.mu_ownerL1C1 );
mu_Clear_perm ( mu_adr, (int)mu_m );
mu_cbe.mu_State = mu_directoryL1C1_E_GetS;
return mu_true;
break;
case mu_PutEL1C1:
mu_msg = mu_AckL1C1( mu_adr, mu_Put_AckL1C1, (int)mu_m, mu_inmsg.mu_src );
mu_Send_fwd ( mu_msg, (int)mu_m );
mu_RemoveElement_cacheL1C1 ( mu_cbe.mu_cacheL1C1, mu_inmsg.mu_src );
if ( !((mu_cbe.mu_ownerL1C1) == (mu_inmsg.mu_src)) )
{
mu_Clear_perm ( mu_adr, (int)mu_m );
mu_cbe.mu_State = mu_directoryL1C1_E;
return mu_true;
}
if ( (mu_cbe.mu_ownerL1C1) == (mu_inmsg.mu_src) )
{
...
switch ((int) mu_inmsg.mu_mtype) {
case mu_GetML1C1:
mu_msg = mu_RespAckL1C1( mu_adr, mu_GetM_Ack_ADL1C1, (int)mu_m, mu_inmsg.mu_src, mu_cbe.mu_cl, (int)mu_VectorCount_cacheL1C1( mu_cbe.mu_cacheL1C1 ) );
...
mu_Send_fwd ( mu_msg, (int)mu_m );
mu_RemoveElement_cacheL1C1 ( mu_cbe.mu_cacheL1C1, mu_inmsg.mu_src );
if ( (mu_VectorCount_cacheL1C1( mu_cbe.mu_cacheL1C1 )) == (0) )
{
mu_Clear_perm ( mu_adr, (int)mu_m );
mu_cbe.mu_State = mu_directoryL1C1_I;
return mu_true;
...
switch ((int) mu_inmsg.mu_mtype) {
case mu_GetML1C1:
if ( mu_IsElement_cacheL1C1( mu_cbe.mu_cacheL1C1, mu_inmsg.mu_src ) )
{
mu_RemoveElement_cacheL1C1 ( mu_cbe.mu_cacheL1C1, mu_inmsg.mu_src );
mu_msg = mu_RespAckL1C1( mu_adr, mu_GetM_Ack_ADL1C1, (int)mu_m, mu_inmsg.mu_src, mu_cbe.mu_cl, (int)mu_VectorCount_cacheL1C1( mu_cbe.mu_cacheL1C1 ) );
mu_Send_resp ( mu_msg, (int)mu_m );
mu_msg = mu_AckL1C1( mu_adr, mu_InvL1C1, mu_inmsg.mu_src, mu_inmsg.mu_src );
mu_Multicast_fwd_v_cacheL1C1 ( mu_msg, mu_cbe.mu_cacheL1C1, (int)mu_m );
if (mu_inmsg.mu_src.isundefined())
  mu_cbe.mu_ownerL1C1.undefine();
else
  mu_cbe.mu_ownerL1C1 = mu_inmsg.mu_src;
mu_ClearVector_cacheL1C1 ( mu_cbe.mu_cacheL1C1 );
mu_Clear_perm ( mu_adr, (int)mu_m );
mu_cbe.mu_State = mu_directoryL1C1_M;
return mu_true;
}
...
break;
case mu_cacheL1C1_E_evict:
switch ((int) mu_inmsg.mu_mtype) {
case mu_Fwd_GetML1C1:
mu_msg = mu_RespL1C1( mu_adr, mu_GetM_Ack_DL1C1, (int)mu_m, mu_inmsg.mu_src, mu_cbe.mu_cl );
mu_Send_resp ( mu_msg, (int)mu_m );
mu_Clear_perm ( mu_adr, (int)mu_m );
mu_cbe.mu_State = mu_cacheL1C1_E_evict_x_I;
return mu_true;
break;
case mu_Fwd_GetSL1C1:
mu_msg = mu_RespL1C1( mu_adr, mu_GetS_AckL1C1, (int)mu_m, mu_inmsg.mu_src, mu_cbe.mu_cl );
...
mu_Send_resp ( mu_msg, (int)mu_m );
mu_Clear_perm ( mu_adr, (int)mu_m );
mu_cbe.mu_State = mu_cacheL1C1_M_evict_x_I;
return mu_true;
break;
case mu_Fwd_GetSL1C1:
mu_msg = mu_RespL1C1( mu_adr, mu_GetS_AckL1C1, (int)mu_m, mu_inmsg.mu_src, mu_cbe.mu_cl );
...
mu_Send_resp ( mu_msg, (int)mu_m );
mu_Clear_perm ( mu_adr, (int)mu_m );
mu_cbe.mu_State = mu_cacheL1C1_S_evict_x_I;
return mu_true;
break;
case mu_Put_AckL1C1:
mu_Clear_perm ( mu_adr, (int)mu_m );
...
public:
  ...
  mu_1_ENTRY_cacheL1C1& mu_cbe = mu_i_cacheL1C1[mu_m].mu_cb[mu_adr];
bool mu__boolexpr29;
  if (!((mu_cbe.mu_State) == (mu_cacheL1C1_S))) mu__boolexpr29 = FALSE ;
  else {
  mu__boolexpr29 = (mu_network_ready(  )) ; 
}
...
bool mu__boolexpr30;
  ...
  mu__boolexpr30 = (mu_network_ready(  )) ; 
}
	      if (mu__boolexpr30) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr33;
  ...
  mu__boolexpr33 = (mu_network_ready(  )) ; 
}
...
bool mu__boolexpr35;
bool mu__boolexpr36;
  if (!((mu_cbe.mu_State) == (mu_cacheL1C1_S))) mu__boolexpr36 = FALSE ;
  else {
  mu__boolexpr36 = (mu_network_ready(  )) ; 
}
  if (!(mu__boolexpr36)) mu__boolexpr35 = FALSE ;
  else {
  mu__boolexpr35 = ((mu_threadIndex) <= (mu_i_threadIndexes[mu_m].mu_maxIndex)) ; 
}
  if (!(mu__boolexpr35)) mu__boolexpr34 = FALSE ;
  else {
  mu__boolexpr34 = ((mu_currentThread[mu_threadIndex].mu_itype) == (mu_store)) ; 
}
	      if (mu__boolexpr34) {
		if ( ( TRUE  ) )
		  return;
  ...
  mu_1_Address& mu_adr = mu_currentThread[mu_threadIndex].mu_adr;
  mu_1_ENTRY_cacheL1C1& mu_cbe = mu_i_cacheL1C1[mu_m].mu_cb[mu_adr];
mu_FSM_Access_cacheL1C1_S_store ( mu_adr, mu_m );
  };
...
bool mu__boolexpr38;
  ...
  mu__boolexpr38 = ((mu_threadIndex) <= (mu_i_threadIndexes[mu_m].mu_maxIndex)) ; 
}
  if (!(mu__boolexpr38)) mu__boolexpr37 = FALSE ;
  else {
  mu__boolexpr37 = ((mu_currentThread[mu_threadIndex].mu_itype) == (mu_load)) ; 
}
...
bool mu__boolexpr39;
bool mu__boolexpr40;
  if (!((mu_cbe.mu_State) == (mu_cacheL1C1_S))) mu__boolexpr40 = FALSE ;
  else {
...
bool mu__boolexpr41;
bool mu__boolexpr42;
  if (!((mu_cbe.mu_State) == (mu_cacheL1C1_M))) mu__boolexpr42 = FALSE ;
  else {
  mu__boolexpr42 = ((mu_threadIndex) <= (mu_i_threadIndexes[mu_m].mu_maxIndex)) ; 
}
  if (!(mu__boolexpr42)) mu__boolexpr41 = FALSE ;
  else {
  mu__boolexpr41 = ((mu_currentThread[mu_threadIndex].mu_itype) == (mu_load)) ; 
}
...
bool mu__boolexpr44;
  ...
  mu__boolexpr44 = ((mu_threadIndex) <= (mu_i_threadIndexes[mu_m].mu_maxIndex)) ; 
}
  if (!(mu__boolexpr44)) mu__boolexpr43 = FALSE ;
  else {
  mu__boolexpr43 = ((mu_currentThread[mu_threadIndex].mu_itype) == (mu_load)) ; 
}
	      if (mu__boolexpr43) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr45;
bool mu__boolexpr46;
  if (!((mu_cbe.mu_State) == (mu_cacheL1C1_M))) mu__boolexpr46 = FALSE ;
  else {
...
bool mu__boolexpr48;
  ...
  mu__boolexpr48 = ((mu_threadIndex) <= (mu_i_threadIndexes[mu_m].mu_maxIndex)) ; 
}
  if (!(mu__boolexpr48)) mu__boolexpr47 = FALSE ;
  else {
  mu__boolexpr47 = ((mu_currentThread[mu_threadIndex].mu_itype) == (mu_store)) ; 
}
	      if (mu__boolexpr47) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr49;
  ...
  mu__boolexpr49 = (mu_network_ready(  )) ; 
}
  ...
  mu_1_ENTRY_cacheL1C1& mu_cbe = mu_i_cacheL1C1[mu_m].mu_cb[mu_adr];
bool mu__boolexpr50;
  if (!((mu_cbe.mu_State) == (mu_cacheL1C1_M))) mu__boolexpr50 = FALSE ;
  else {
  mu__boolexpr50 = (mu_network_ready(  )) ; 
}
	      if (mu__boolexpr50) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr52;
bool mu__boolexpr53;
  if (!((mu_cbe.mu_State) == (mu_cacheL1C1_I))) mu__boolexpr53 = FALSE ;
  else {
  mu__boolexpr53 = (mu_network_ready(  )) ; 
}
  if (!(mu__boolexpr53)) mu__boolexpr52 = FALSE ;
  else {
  mu__boolexpr52 = ((mu_threadIndex) <= (mu_i_threadIndexes[mu_m].mu_maxIndex)) ; 
}
  if (!(mu__boolexpr52)) mu__boolexpr51 = FALSE ;
  else {
  mu__boolexpr51 = ((mu_currentThread[mu_threadIndex].mu_itype) == (mu_load)) ; 
}
...
bool mu__boolexpr55;
bool mu__boolexpr56;
  if (!((mu_cbe.mu_State) == (mu_cacheL1C1_I))) mu__boolexpr56 = FALSE ;
  else {
  mu__boolexpr56 = (mu_network_ready(  )) ; 
}
  if (!(mu__boolexpr56)) mu__boolexpr55 = FALSE ;
  else {
  mu__boolexpr55 = ((mu_threadIndex) <= (mu_i_threadIndexes[mu_m].mu_maxIndex)) ; 
}
  if (!(mu__boolexpr55)) mu__boolexpr54 = FALSE ;
  else {
  mu__boolexpr54 = ((mu_currentThread[mu_threadIndex].mu_itype) == (mu_load)) ; 
}
	      if (mu__boolexpr54) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr58;
bool mu__boolexpr59;
  if (!((mu_cbe.mu_State) == (mu_cacheL1C1_I))) mu__boolexpr59 = FALSE ;
  else {
  mu__boolexpr59 = (mu_network_ready(  )) ; 
}
  if (!(mu__boolexpr59)) mu__boolexpr58 = FALSE ;
  else {
  mu__boolexpr58 = ((mu_threadIndex) <= (mu_i_threadIndexes[mu_m].mu_maxIndex)) ; 
}
  if (!(mu__boolexpr58)) mu__boolexpr57 = FALSE ;
  else {
  mu__boolexpr57 = ((mu_currentThread[mu_threadIndex].mu_itype) == (mu_store)) ; 
}
...
bool mu__boolexpr61;
bool mu__boolexpr62;
  if (!((mu_cbe.mu_State) == (mu_cacheL1C1_I))) mu__boolexpr62 = FALSE ;
  else {
  mu__boolexpr62 = (mu_network_ready(  )) ; 
}
  if (!(mu__boolexpr62)) mu__boolexpr61 = FALSE ;
  else {
  mu__boolexpr61 = ((mu_threadIndex) <= (mu_i_threadIndexes[mu_m].mu_maxIndex)) ; 
}
  if (!(mu__boolexpr61)) mu__boolexpr60 = FALSE ;
  else {
  mu__boolexpr60 = ((mu_currentThread[mu_threadIndex].mu_itype) == (mu_store)) ; 
}
	      if (mu__boolexpr60) {
		if ( ( TRUE  ) )
		  return;
  ...
  mu_1_Address& mu_adr = mu_currentThread[mu_threadIndex].mu_adr;
  mu_1_ENTRY_cacheL1C1& mu_cbe = mu_i_cacheL1C1[mu_m].mu_cb[mu_adr];
mu_FSM_Access_cacheL1C1_I_store ( mu_adr, mu_m );
  };
...
public:
  ...
  char * Name(unsigned r)
  {
    ...
    mu_m.value((r % 3) + 41);
    r = r / 3;
    return tsprintf("cacheL1C1_E_evict, m:%s", mu_m.Name());
  }
  bool Condition(unsigned r)
  {
    static mu_1_OBJSET_cacheL1C1 mu_m;
  ...
  mu_1_ENTRY_cacheL1C1& mu_cbe = mu_i_cacheL1C1[mu_m].mu_cb[mu_adr];
bool mu__boolexpr63;
  if (!((mu_cbe.mu_State) == (mu_cacheL1C1_E))) mu__boolexpr63 = FALSE ;
  else {
  ...
  mu_1_ENTRY_cacheL1C1& mu_cbe = mu_i_cacheL1C1[mu_m].mu_cb[mu_adr];
bool mu__boolexpr64;
  if (!((mu_cbe.mu_State) == (mu_cacheL1C1_E))) mu__boolexpr64 = FALSE ;
  else {
  ...
  mu_1_Address& mu_adr = mu_currentThread[mu_threadIndex].mu_adr;
  mu_1_ENTRY_cacheL1C1& mu_cbe = mu_i_cacheL1C1[mu_m].mu_cb[mu_adr];
mu_FSM_Access_cacheL1C1_E_evict ( mu_adr, mu_m );
  };
...
public:
  ...
  char * Name(unsigned r)
  {
    ...
    mu_m.value((r % 3) + 41);
    r = r / 3;
    return tsprintf("cacheL1C1_E_store, m:%s", mu_m.Name());
  }
  bool Condition(unsigned r)
  {
    static mu_1_OBJSET_cacheL1C1 mu_m;
...
bool mu__boolexpr65;
bool mu__boolexpr66;
  if (!((mu_cbe.mu_State) == (mu_cacheL1C1_E))) mu__boolexpr66 = FALSE ;
  else {
  mu__boolexpr66 = ((mu_threadIndex) <= (mu_i_threadIndexes[mu_m].mu_maxIndex)) ; 
}
  if (!(mu__boolexpr66)) mu__boolexpr65 = FALSE ;
  else {
  mu__boolexpr65 = ((mu_currentThread[mu_threadIndex].mu_itype) == (mu_store)) ; 
}
...
bool mu__boolexpr67;
bool mu__boolexpr68;
  if (!((mu_cbe.mu_State) == (mu_cacheL1C1_E))) mu__boolexpr68 = FALSE ;
  else {
  mu__boolexpr68 = ((mu_threadIndex) <= (mu_i_threadIndexes[mu_m].mu_maxIndex)) ; 
}
  if (!(mu__boolexpr68)) mu__boolexpr67 = FALSE ;
  else {
  mu__boolexpr67 = ((mu_currentThread[mu_threadIndex].mu_itype) == (mu_store)) ; 
}
	      if (mu__boolexpr67) {
		if ( ( TRUE  ) )
		  return;
  ...
  mu_1_Address& mu_adr = mu_currentThread[mu_threadIndex].mu_adr;
  mu_1_ENTRY_cacheL1C1& mu_cbe = mu_i_cacheL1C1[mu_m].mu_cb[mu_adr];
mu_FSM_Access_cacheL1C1_E_store ( mu_adr, mu_m );
  };
...
public:
  ...
  char * Name(unsigned r)
  {
    ...
    mu_m.value((r % 3) + 41);
    r = r / 3;
    return tsprintf("cacheL1C1_E_load, m:%s", mu_m.Name());
  }
  bool Condition(unsigned r)
  {
    static mu_1_OBJSET_cacheL1C1 mu_m;
...
bool mu__boolexpr69;
bool mu__boolexpr70;
  if (!((mu_cbe.mu_State) == (mu_cacheL1C1_E))) mu__boolexpr70 = FALSE ;
  else {
  mu__boolexpr70 = ((mu_threadIndex) <= (mu_i_threadIndexes[mu_m].mu_maxIndex)) ; 
}
  if (!(mu__boolexpr70)) mu__boolexpr69 = FALSE ;
  else {
  mu__boolexpr69 = ((mu_currentThread[mu_threadIndex].mu_itype) == (mu_load)) ; 
}
...
bool mu__boolexpr71;
bool mu__boolexpr72;
  if (!((mu_cbe.mu_State) == (mu_cacheL1C1_E))) mu__boolexpr72 = FALSE ;
  else {
  mu__boolexpr72 = ((mu_threadIndex) <= (mu_i_threadIndexes[mu_m].mu_maxIndex)) ; 
}
  if (!(mu__boolexpr72)) mu__boolexpr71 = FALSE ;
  else {
  mu__boolexpr71 = ((mu_currentThread[mu_threadIndex].mu_itype) == (mu_load)) ; 
}
	      if (mu__boolexpr71) {
		if ( ( TRUE  ) )
		  return;
  ...
  mu_1_Address& mu_adr = mu_currentThread[mu_threadIndex].mu_adr;
  mu_1_ENTRY_cacheL1C1& mu_cbe = mu_i_cacheL1C1[mu_m].mu_cb[mu_adr];
mu_FSM_Access_cacheL1C1_E_load ( mu_adr, mu_m );
mu_i_threadIndexes[mu_m].mu_currentIndex = (mu_threadIndex) + (1);
mu_instructionsExecuted = (mu_instructionsExecuted) + (1);
if ( (mu_instructionsExecuted) == (6) )
{
...
bool Condition(unsigned r)
{
  ...
  if (r>=72 && r<=74) return R11.Condition(r-72);
  if (r>=75 && r<=77) return R12.Condition(r-75);
  if (r>=78 && r<=80) return R13.Condition(r-78);
...
void Code(unsigned r)
{
  ...
  if (r>=72 && r<=74) { R11.Code(r-72); return; } 
  if (r>=75 && r<=77) { R12.Code(r-75); return; } 
  if (r>=78 && r<=80) { R13.Code(r-78); return; } 
}
int Priority(unsigned short r)
{
  ...
  if (r>=72 && r<=74) { return R11.Priority(); } 
  if (r>=75 && r<=77) { return R12.Priority(); } 
  if (r>=78 && r<=80) { return R13.Priority(); } 
return 0;}
char * Name(unsigned r)
{
  ...
  if (r>=72 && r<=74) return R11.Name(r-72);
  if (r>=75 && r<=77) return R12.Name(r-75);
  if (r>=78 && r<=80) return R13.Name(r-78);
  return NULL;
}
};
const unsigned numrules = 81;

/********************
  parameter
 ********************/
#define RULES_IN_WORLD 81
...
: Presentation(Simple)
{
 ...
 revperm_mu_1_OBJSET_cacheL1C1 = new arr_mu_1_OBJSET_cacheL1C1[6];
    ...
    for (i=0; i<6; i++)
      for (j=41; j<=43; j++)
        for (k=41; k<=43; k++)
          if (revperm_mu_1_OBJSET_cacheL1C1[i][k-41]==j)   // k - base 
            perm_mu_1_OBJSET_cacheL1C1[i][j-41]=k; // j - base 
...
void PermSet::SimpleToExplicit()
{
  ...
  for (i=0; i<6; i++) // to be in or not to be
    for (k=0; k<3; k++) // step through class_mu_1_pid[k]
      if (! (perm_mu_1_OBJSET_cacheL1C1[i][k]-41 >=start_mu_1_OBJSET_cacheL1C1[k] 
	     && perm_mu_1_OBJSET_cacheL1C1[i][k]-41 < start_mu_1_OBJSET_cacheL1C1[k] + size_mu_1_OBJSET_cacheL1C1[k]) )
  	    {
  ...
  for (j=0; j<=undefined_class_mu_1_OBJSET_cacheL1C1; j++) // class number
    {
      for (k=0; k<3; k++) // step through class_mu_1_pid[k]
	    if (class_mu_1_OBJSET_cacheL1C1[k]==j)
	      revperm_mu_1_OBJSET_cacheL1C1[0][start++] = k+41;
    }
  for (j=0; j<3; j++)
    for (k=0; k<3; k++)
      if (revperm_mu_1_OBJSET_cacheL1C1[0][k]==j+41)
        perm_mu_1_OBJSET_cacheL1C1[0][j]=k+41;
  Presentation = Explicit;
}
...
void PermSet::GenPerm0(mu_1_OBJSET_cacheL1C1* Perm,int size, unsigned long& count)
{
  ...
  if (size!=3)
    ...
    {
      for (i=41; i<=43; i++)
        revperm_mu_1_OBJSET_cacheL1C1[count][i-41]=Perm[i-41].value();// i - base
      count++;
    }
}
...
bool PermSet::NextPermutation()
{
  ...
  for (start = 0; start < 3; )
    {
      end = start-1+size_mu_1_OBJSET_cacheL1C1[revperm_mu_1_OBJSET_cacheL1C1[0][start]-41];
...
if (!nexted) return FALSE;
  for (j=0; j<3; j++)
    for (k=0; k<3; k++)
      if (revperm_mu_1_OBJSET_cacheL1C1[0][k]==j+41)   // k - base 
	perm_mu_1_OBJSET_cacheL1C1[0][j]=k+41; // j - base 
  return TRUE;
}
...
void mu_1_OBJSET_cacheL1C1::Permute(PermSet& Perm, int i)
{
  ...
  if (defined())
    value(Perm.perm_mu_1_OBJSET_cacheL1C1[Perm.in_mu_1_OBJSET_cacheL1C1[i]][value()-41]); // value - base
};
void mu_1_OBJSET_cacheL1C1::SimpleCanonicalize(PermSet& Perm)
{
  ...
  if (defined())
    if (Perm.class_mu_1_OBJSET_cacheL1C1[value()-41]==Perm.undefined_class_mu_1_OBJSET_cacheL1C1) // value - base
      {
        // it has not been mapped to any particular value
        for (i=0; i<3; i++)
          if (Perm.class_mu_1_OBJSET_cacheL1C1[i] == Perm.undefined_class_mu_1_OBJSET_cacheL1C1 && i!=value()-41)
            Perm.class_mu_1_OBJSET_cacheL1C1[i]++;
        value(41 + Perm.undefined_class_mu_1_OBJSET_cacheL1C1++);
      }
    else 
      {
        value(Perm.class_mu_1_OBJSET_cacheL1C1[value()-41]+41);
      }
}
...
void mu_1_Machines::Permute(PermSet& Perm, int i)
{
  ...
  if (defined()) {
    if ( ( value() >= 41 ) && ( value() <= 43 ) )
      value(Perm.perm_mu_1_OBJSET_cacheL1C1[Perm.in_mu_1_OBJSET_cacheL1C1[i]][value()-41]+(0)); // value - base
  }
}
...
void mu_1_threadlist::Permute(PermSet& Perm, int i)
{
  ...
  temp = *this;
  for (j=41; j<=43; j++)
    (*this)[j] = temp[Perm.revperm_mu_1_OBJSET_cacheL1C1[Perm.in_mu_1_OBJSET_cacheL1C1[i]][j-41]];};
...
void mu_1_threadlist::Canonicalize(PermSet& Perm)
{
      ...
      for (i=0; i<3; i++)
        {
          for (j=0; j<count_mu_1_OBJSET_cacheL1C1; j++)
            {
              compare = CompareWeight(value[j],(*this)[i+41]);
              if (compare==0)
                {
  ...
  if (Perm.MTO_class_mu_1_OBJSET_cacheL1C1())
  ...
  else
    {
      ...
      temp = *this;
      for (j=0; j<3; j++)
        array[Perm.class_mu_1_OBJSET_cacheL1C1[j]+0] = temp[j+41];
    }
}
  ...
  if (Perm.MTO_class_mu_1_OBJSET_cacheL1C1() && count_mu_1_OBJSET_cacheL1C1<3)
    {
      ...
      for (k=0; k<3; k++) // step through class
        if ((*this)[k+41][i0].mu_src.isundefined()
            ||(*this)[k+41][i0].mu_src!=k+41)
          exists = TRUE;
        else
          split = TRUE;
      if (exists && split)
          ...
          for (i=0; i<count_mu_1_OBJSET_cacheL1C1; i++) // for value priority
            {
              ...
              for (k=0; k<3; k++) // step through class
                if (pos_mu_1_OBJSET_cacheL1C1[i][k] 
                    && !(*this)[k+41][i0].mu_src.isundefined()
                    && (*this)[k+41][i0].mu_src==k+41)
                  {
                    exists = TRUE;
                    goodset_mu_1_OBJSET_cacheL1C1[k] = TRUE;
  ...
  if (Perm.MTO_class_mu_1_OBJSET_cacheL1C1() && count_mu_1_OBJSET_cacheL1C1<3)
    {
      ...
      // if there exists both self loop and non-self loop
      for (k=0; k<3; k++) // step through class
        if ((*this)[k+41][i0].mu_dst.isundefined()
            ||(*this)[k+41][i0].mu_dst!=k+41)
          exists = TRUE;
        else
          split = TRUE;
      if (exists && split)
          ...
          for (i=0; i<count_mu_1_OBJSET_cacheL1C1; i++) // for value priority
            {
              ...
              for (k=0; k<3; k++) // step through class
                if (pos_mu_1_OBJSET_cacheL1C1[i][k] 
                    && !(*this)[k+41][i0].mu_dst.isundefined()
                    && (*this)[k+41][i0].mu_dst==k+41)
                  {
                    exists = TRUE;
                    goodset_mu_1_OBJSET_cacheL1C1[k] = TRUE;
      ...
      if (Perm.MTO_class_mu_1_OBJSET_cacheL1C1() && count_mu_1_OBJSET_cacheL1C1<3)
        {
          ...
          for (k=0; k<3; k++) // step through class
            if (!(*this)[k+41][i0].mu_src.isundefined()
                &&(*this)[k+41][i0].mu_src!=k+41
                &&(*this)[k+41][i0].mu_src>=41
                &&(*this)[k+41][i0].mu_src<=43)
              exists = TRUE;
          if (exists)
            {
              for (i=0; i<count_mu_1_OBJSET_cacheL1C1; i++) // for value priority
                  ...
                  for (j=0; j<count_mu_1_OBJSET_cacheL1C1; j++) // for value priority
                    {
                      ...
                      for (k=0; k<3; k++) // step through class
                        if (pos_mu_1_OBJSET_cacheL1C1[i][k] 
                            ...
                            && (*this)[k+41][i0].mu_src>=41
                            && (*this)[k+41][i0].mu_src<=43
                            && pos_mu_1_OBJSET_cacheL1C1[j][(*this)[k+41][i0].mu_src-41])
                          {
                            exists = TRUE;
                            goodset_mu_1_OBJSET_cacheL1C1[k] = TRUE;
                          }
      ...
      if (Perm.MTO_class_mu_1_OBJSET_cacheL1C1() && count_mu_1_OBJSET_cacheL1C1<3)
        {
          ...
          for (k=0; k<3; k++) // step through class
            if (!(*this)[k+41][i0].mu_dst.isundefined()
                &&(*this)[k+41][i0].mu_dst!=k+41
                &&(*this)[k+41][i0].mu_dst>=41
                &&(*this)[k+41][i0].mu_dst<=43)
              exists = TRUE;
          if (exists)
            {
              for (i=0; i<count_mu_1_OBJSET_cacheL1C1; i++) // for value priority
                  ...
                  for (j=0; j<count_mu_1_OBJSET_cacheL1C1; j++) // for value priority
                    {
                      ...
                      for (k=0; k<3; k++) // step through class
                        if (pos_mu_1_OBJSET_cacheL1C1[i][k] 
                            ...
                            && (*this)[k+41][i0].mu_dst>=41
                            && (*this)[k+41][i0].mu_dst<=43
                            && pos_mu_1_OBJSET_cacheL1C1[j][(*this)[k+41][i0].mu_dst-41])
                          {
                            exists = TRUE;
                            goodset_mu_1_OBJSET_cacheL1C1[k] = TRUE;
                          }
...
void mu_1_NET_Ordered_cnt::Permute(PermSet& Perm, int i)
{
  ...
  temp = *this;
  for (j=41; j<=43; j++)
      (*this)[j].value(temp[Perm.revperm_mu_1_OBJSET_cacheL1C1[Perm.in_mu_1_OBJSET_cacheL1C1[i]][j-41]].value());
};
...
void mu_1_NET_Ordered_cnt::Canonicalize(PermSet& Perm)
{
  ...
  if (Perm.MTO_class_mu_1_OBJSET_cacheL1C1())
      ...
      for (i=0; i<3; i++)
        for (j=0; j<3; j++)
         if (i >=start_mu_1_OBJSET_cacheL1C1[j] 
             && i < start_mu_1_OBJSET_cacheL1C1[j] + size_mu_1_OBJSET_cacheL1C1[j])
           {
             array[i+1].value(temp[j+41].value());
             break;
           }
    }
  else
    {
      ...
      temp = *this;
      for (j=0; j<3; j++)
        array[Perm.class_mu_1_OBJSET_cacheL1C1[j]+1].value(temp[j+41].value());
    }
}
                ...
                for (j=0; j<count_mu_1_OBJSET_cacheL1C1; j++) //scan through element priority
                  {
                    ...
                    for (k=0; k<current_size; k++) // scan array index
                      ...
                      if (pos_multisetindex[i][k] 
                          ...
                          && (*this)[k].mu_src>=41
                          && (*this)[k].mu_src<=43
                          && pos_mu_1_OBJSET_cacheL1C1[j][(*this)[k].mu_src-41])
                        {
                          exists = TRUE;
                          goodset_multisetindex[k] = TRUE;
                          goodset_mu_1_OBJSET_cacheL1C1[(*this)[k].mu_src-41] = TRUE;
                        }
                    if (exists)
                      {
                ...
                for (j=0; j<count_mu_1_OBJSET_cacheL1C1; j++) //scan through element priority
                  {
                    ...
                    for (k=0; k<current_size; k++) // scan array index
                      ...
                      if (pos_multisetindex[i][k] 
                          ...
                          && (*this)[k].mu_dst>=41
                          && (*this)[k].mu_dst<=43
                          && pos_mu_1_OBJSET_cacheL1C1[j][(*this)[k].mu_dst-41])
                        {
                          exists = TRUE;
                          goodset_multisetindex[k] = TRUE;
                          goodset_mu_1_OBJSET_cacheL1C1[(*this)[k].mu_dst-41] = TRUE;
                        }
                    if (exists)
                      {
                        // set split for the array index type
...
{ Error.Error("Internal: calling MultisetLimit for scalarset array.\n"); };
void mu_1_v_cacheL1C1::Permute(PermSet& Perm, int i)
{
  static mu_1_v_cacheL1C1 temp("Permute_mu_1_v_cacheL1C1",-1);
  int j;
  for (j=0; j<3; j++)
    array[j].Permute(Perm, i);
};
void mu_1_v_cacheL1C1::SimpleCanonicalize(PermSet& Perm)
{ Error.Error("Internal: calling SimpleCanonicalize for a multiset.\n"); };
void mu_1_v_cacheL1C1::Canonicalize(PermSet& Perm)
{ Error.Error("You cannot use this symmetry algorithm with Multiset.\n"); };
void mu_1_v_cacheL1C1::SimpleLimit(PermSet& Perm)
{ Error.Error("You cannot use this symmetry algorithm with Multiset.\n"); };
void mu_1_v_cacheL1C1::ArrayLimit(PermSet& Perm)
{ Error.Error("You cannot use this symmetry algorithm with Multiset.\n"); };
void mu_1_v_cacheL1C1::Limit(PermSet& Perm)
{ Error.Error("You cannot use this symmetry algorithm with Multiset.\n"); };
void mu_1_v_cacheL1C1::MultisetLimit(PermSet& Perm)
{
  // indexes
  int i,j,k,z;
  // while guard
                ...
                for (j=0; j<count_mu_1_OBJSET_cacheL1C1; j++) //scan through element priority
                  {
                    ...
                    for (k=0; k<current_size; k++) // scan array index
                      ...
                      if (pos_multisetindex[i][k] 
                          ...
                          && (*this)[k]>=41
                          && (*this)[k]<=43
                          && pos_mu_1_OBJSET_cacheL1C1[j][(*this)[k]-41])
                        {
                          exists = TRUE;
                          goodset_multisetindex[k] = TRUE;
                          goodset_mu_1_OBJSET_cacheL1C1[(*this)[k]-41] = TRUE;
                        }
                    if (exists)
                      {
                        // set split for the array index type
...
void mu_1_cnt_v_cacheL1C1::Permute(PermSet& Perm, int i) {};
void mu_1_cnt_v_cacheL1C1::SimpleCanonicalize(PermSet& Perm) {};
void mu_1_cnt_v_cacheL1C1::Canonicalize(PermSet& Perm) {};
void mu_1_cnt_v_cacheL1C1::SimpleLimit(PermSet& Perm) {};
void mu_1_cnt_v_cacheL1C1::ArrayLimit(PermSet& Perm) {};
void mu_1_cnt_v_cacheL1C1::Limit(PermSet& Perm) {};
void mu_1_cnt_v_cacheL1C1::MultisetLimit(PermSet& Perm)
{ Error.Error("Internal: calling MultisetLimit for subrange type.\n"); };
